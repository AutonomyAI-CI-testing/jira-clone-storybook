export function TestCard() {
  return (
    <div id="testElem">
      <div className="w-[340px] bg-[#1a1a1a] px-6 py-6 text-[#c8c8c8] font-sans">
        {/* Header */}
        ...
        <div className="mb-5 flex items-center gap-2 text-[#c8c8c8]">
          ...
          <h2 className="text-base font-medium">Add New Design</h2>
        </div>
        ...
        <div className="mb-4">
          <div className="mb-2 flex items-center gap-2">
            ...
            <span
              aria-hidden
              className="inline-flex h-4 w-4 items-center justify-center rounded-full border border-[#6a6a6a] text-[10px] text-[#8a8a8a]"
            >
              i
            </span>
          </div>
        ...
        <div className="mb-6">
          ...
          <input
            ...
            className="w-full rounded border border-[#9a9a9a] bg-[#2a2a2a] px-3 py-2.5 text-sm text-[#b0b0b0] outline-none"
          />
        </div>
        ...
        <div className="mb-10 flex justify-center gap-3">
          <button
            type="button"
            className="min-w-[110px] rounded-md bg-[#a54a20] px-5 py-2.5 text-sm font-medium text-[#d4a090]"
          >
            Awesome
          </button>
          <button
        ...
        {/* Footer */}
        <h3 className="text-base font-medium text-[#c8c8c8]">Recent Breakdowns</h3>
      </div>
    </div>
  );
}
