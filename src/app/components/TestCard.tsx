      ...
      <div className="px-5 flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div
            ...
            style={{ backgroundColor: "#272822", border: "1px solid #a5adad", height: "37px", borderRadius: "2px" }}
          >
        ...
        <div className="flex flex-col gap-2">
          ...
          <div
            className="flex items-center px-3"
            style={{ backgroundColor: "#272822", border: "2px solid #929291", height: "37px", borderRadius: "2px" }}
          >
