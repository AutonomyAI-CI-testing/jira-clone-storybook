...
export const Title = ({
  ...
  // Check if either text area has reached max length to change character count color
  const isMaxLength = title.length >= maxLength;
  const isSubtitleMaxLength = subtitle.length >= subtitleMaxLength;
  // Show error when title is required but empty or contains only whitespace
  const requireError =
