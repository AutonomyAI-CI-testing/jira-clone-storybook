export function TestCard() {
  return (
    <div id="testElem">
      <div className="bg-[#2a2a2a] text-white w-[320px] p-5 rounded-lg font-sans">
        {/* Header */}
        ...
        {/* Subtitle */}
        <div className="flex items-center gap-1 text-[#c4904a] text-sm mb-6">
        ...
        <div className="flex gap-3 mb-8">
          <button className="flex-1 bg-[#b85c2a] hover:bg-[#a04f22] text-white font-semibold py-2 rounded-lg transition-colors">
            Awesome
          </button>
          <button className="flex-1 bg-[#b85c2a] hover:bg-[#a04f22] text-white font-semibold py-2 rounded-lg transition-colors">
            Prepare
