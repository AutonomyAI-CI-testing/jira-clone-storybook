  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="w-full px-3 py-2 text-xs font-semibold rounded outline-none mb-3"
        style={{
      ...
      <input
        ...
        className="w-full px-3 py-2 text-xs font-semibold rounded outline-none mb-5"
        style={{
          backgroundColor: "#272822",
      ...
      <div className="flex gap-3 justify-center mb-8">
        <button
          ...
          style={{ backgroundColor: "#843a17", color: "#c8b8a8" }}
        >
          Awesome
        </button>
        <button
