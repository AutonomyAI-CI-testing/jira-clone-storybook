...
export const Title = ({
  ...
  // Show error only when an error message is provided and the field is empty or contains only spaces
  const requireError =
  ...
  return (
    <div className="space-y-2">
      <div className="relative">
        ...
        {/* Character count displayed only when the title field is focused */}
        {isFocus && (
          <span
            className={cx(
      ...
      <div className="relative">
        ...
        {/* Character count displayed only when the subtitle field is focused */}
        {isSubtitleFocus && (
          <span
            className={cx(
              "absolute right-0 top-full font-primary-light text-sm",
