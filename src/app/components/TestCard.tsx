...
export const TestCard = (): JSX.Element => {
  return (
    <div
      id="testElem"
      className="w-full max-w-[380px] bg-[#2a2a2a] px-5 py-6 font-sans text-white"
    >
      {/* Header row */}
      ...
      <div className="mt-5">
        ...
        <input
          ...
          className="w-full rounded border border-[#555] bg-[#383838] px-3 py-2.5 text-sm text-gray-300 placeholder-gray-500 outline-none"
        />
      </div>
      ...
      <div className="mt-4">
        ...
        <input
          ...
          className="w-full rounded border border-[#666] bg-[#383838] px-3 py-2.5 text-sm text-gray-300 placeholder-gray-500 outline-none"
        />
      </div>

      {/* Buttons */}
      <div className="mt-6 flex justify-center gap-4">
        <button className="rounded-lg bg-[#b85c2a] px-8 py-3 text-sm font-semibold text-white">
          Awesome
        </button>
        <button className="rounded-lg bg-[#b85c2a] px-8 py-3 text-sm font-semibold text-white">
          Prepare
