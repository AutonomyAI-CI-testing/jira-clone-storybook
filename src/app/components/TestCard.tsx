export function TestCard() {
  return (
    <div id="testElem" className="min-h-screen flex items-center justify-center" style={{ backgroundColor: "#1a1a18" }}>
      <div
        className="w-64 rounded-lg p-5 flex flex-col gap-4"
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <svg width="10" height="7" viewBox="0 0 10 7" fill="none">
            <polyline points="1,6 5,2 9,6" stroke="#8b9291" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        ...
        {/* ── Divider ── */}
        <div style={{ borderTop: "1px solid #3a3a36" }} />
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center gap-2">
            <svg width="12" height="8" viewBox="0 0 12 8" fill="none">
              <polyline points="1,7 6,2 11,7" stroke="#b2b2b1" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
