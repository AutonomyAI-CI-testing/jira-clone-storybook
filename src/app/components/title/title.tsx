...
/**
 * Displays character count for a text field.
 * Shows in danger color when max length is reached, otherwise in subtle color.
 */
...
export const Title = ({
  ...
  // Title starts focused to encourage immediate input on mount
  ...
  const updateTitle = (newTitle: string) => {
    // Prevent input beyond max length rather than truncating — preserves user intent
