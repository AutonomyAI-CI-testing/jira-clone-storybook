  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-2">
        <span className="text-xl font-semibold" style={{ color: "#b5b5b5" }}>
          UI magician Agent
        </span>
        {/* Gear icon */}
        <svg
      ...
      {/* Subtitle row */}
      <div className="flex items-center gap-2 mb-8" style={{ color: "#8b9291" }}>
        {/* Chevron-up icon */}
        <svg
          width="16"
          height="16"
      ...
      <div className="flex gap-4 mb-10">
        <button
          ...
          style={{ backgroundColor: "#843a17", color: "#d4b8a8" }}
        >
          Awesome
        </button>
        <button
