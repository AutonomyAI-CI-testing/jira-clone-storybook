export const TestCard = () => {
  return (
    <div
      id="testElem"
      className="bg-[#2a2a2a] text-white w-full max-w-sm mx-auto p-5 font-sans min-h-screen"
    >
      {/* Header */}
      ...
      {/* Collapsed row */}
      <div className="flex items-center gap-2 mb-10 text-[#c07a4a]">
        {/* Chevron up */}
        <svg
          className="w-4 h-4"
          fill="none"
      ...
      <div>
        ...
        <div className="flex gap-3">
          <button className="flex-1 bg-[#b85c2a] text-white font-medium py-3 px-4 rounded-lg">
            Awesome
          </button>
          <button className="flex-1 bg-[#b85c2a] text-white font-medium py-3 px-4 rounded-lg">
            Prepare
