...
export const TestCard = (): JSX.Element => {
  return (
    <div
      id="testElem"
      className="flex w-64 flex-col gap-4 rounded-md bg-[#161513] p-4 font-sans"
    >
      {/* Header */}
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-1">
          <div className="flex items-center gap-1">
            ...
            <HiInformationCircle className="h-3 w-3 text-[#a4a4a3]" />
          </div>
          <div className="rounded border-2 border-[#929291] bg-[#272822] px-2 py-1.5">
        ...
        <div className="flex flex-col gap-1">
          <div className="flex items-center gap-1">
            ...
            <HiInformationCircle className="h-3 w-3 text-[#a3a3a2]" />
          </div>
          <div className="rounded border border-[#a5adad] bg-[#272822] px-2 py-1.5">
