export const TestCard = () => {
  return (
    <div
      id="testElem"
      className="w-64 bg-zinc-900 p-5 font-sans"
      style={{ backgroundColor: "#1a1a1a" }}
    >
      {/* Header row */}
      <div className="flex items-center justify-between mb-2">
        <span className="text-base font-semibold" style={{ color: "#b5b5b5" }}>
          UI magician Agent
        </span>
        <svg
          width="20"
      ...
      <div className="flex gap-3 mb-8">
        <button
          ...
          style={{ backgroundColor: "#9a3a1a", color: "#d4c4bc" }}
        >
          Awesome
        </button>
        <button
      ...
      {/* Recent Breakdowns */}
      <div>
        <span className="text-lg font-bold" style={{ color: "#b0b0b0" }}>
          Recent Breakdowns
        </span>
      </div>
    </div>
