export const TestCard = (): JSX.Element => {
  return (
    <div
      id="testElem"
      className="w-[254px] min-h-[508px] bg-[#1c1c1c] p-5 flex flex-col gap-4"
    >
      {/* Header row */}
      ...
      {/* Collapsible row — From entire frame... */}
      ...
      <div className="flex flex-col gap-2">
        ...
        <input
          ...
          className="w-full bg-[#272822] border border-[#a5adad] rounded px-3 py-2 text-[11.5px] font-semibold text-[#737470] placeholder:text-[#737470] outline-none"
        />
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <input
          ...
          className="w-full bg-[#272822] border border-[#929291] rounded px-3 py-2 text-[11.5px] font-semibold text-[#71726e] placeholder:text-[#71726e] outline-none"
        />
      </div>
      ...
      <div className="flex items-center gap-3 justify-center">
        <button
          type="button"
          className="flex-1 bg-[#843a17] text-[#8c8078] text-[11.5px] font-semibold rounded py-[10px] px-4"
        >
          Awesome
        </button>
        <button
