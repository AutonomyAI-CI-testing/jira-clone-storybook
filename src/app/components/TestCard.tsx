export function TestCard() {
  return (
    <div
      id="testElem"
      className="w-[254px] bg-[#282923] overflow-hidden font-sans"
    >
      {/* Header row */}
      ...
      <div className="px-5 pb-4">
        ...
        <div className="mb-3">
          ...
          <div className="bg-[#272822] border border-[#929291] px-3 py-2.5">
        ...
        <div className="flex gap-3">
          <button className="flex-1 py-2.5 bg-[#843a17] rounded text-[11.5px] font-semibold text-[#8c8078]">
            Awesome
          </button>
          <button className="flex-1 py-2.5 bg-[#843a17] rounded text-[11.5px] font-semibold text-[#8c8078]">
            Prepare
