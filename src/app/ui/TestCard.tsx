export function TestCard() {
  return (
    <div
      id="testElem"
      className="w-[254px] bg-[#1a1a17] flex flex-col gap-4 p-5"
    ...
    >
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="bg-[#272822] border border-[#a5adad] w-full px-3 py-2">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="bg-[#272822] border-2 border-[#929291] w-full px-3 py-2">
        ...
        <div className="flex gap-3">
          <button
            className="bg-[#843a17] rounded text-[#8c8078] text-[11.5px] font-semibold leading-[13.92px] flex-1 h-[37px]"
            type="button"
          >
            Awesome
          </button>
