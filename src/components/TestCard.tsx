...
export const TestCard = (): JSX.Element => {
  return (
    <div id="testElem" className="font-sans w-[254px] bg-[#2a2a2a] p-5 text-sm">
      ...
      {/* Spacer / divider area (implied by margin in subtitle row) */}

      {/* Add New Design section */}
      <div className="mb-4 flex items-center gap-2">
        <IoChevronUp size={12} className="text-[#b2b2b1]" />
      ...
      <div className="mb-3">
        <div className="mb-1 flex items-center gap-2">
          ...
          <HiInformationCircle size={14} className="text-[#a4a4a3]" />
        </div>
        <input
          id="pat"
          type="text"
      ...
      <div className="mb-3">
        <div className="mb-1 flex items-center gap-2">
          ...
          <HiInformationCircle size={14} className="text-[#a3a3a2]" />
        </div>
        <input
          id="designUrl"
          type="text"
