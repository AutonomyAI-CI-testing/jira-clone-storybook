export function TestCard() {
  return (
    <div
      id="testElem"
      className="w-64 min-h-screen bg-[#272822] font-sans flex flex-col"
    >
      {/* Header row */}
      <div className="flex items-center justify-between px-5 pt-5 pb-2">
        <span
          className="text-[#b5b5b5] text-[13.5px] font-semibold leading-tight"
        >
          UI magician Agent
        </span>
        {/* Gear / settings icon */}
      ...
      <div className="px-5">
        ...
        <div className="flex gap-3">
          <button
            type="button"
            className="flex-1 bg-[#843a17] rounded text-[#8c8078] text-[11.5px] font-semibold py-2.5"
          >
            Awesome
          </button>
          <button
