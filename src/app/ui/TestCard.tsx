export function TestCard() {
  return (
    <div
      ...
      className="flex flex-col px-5 py-5 gap-3"
    >
      {/* Header row */}
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-1">
          <div className="flex items-center gap-1">
            ...
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
              ...
              <text x="7.5" y="11" textAnchor="middle" fill="#a4a4a3" fontSize="8" fontFamily="Inter">i</text>
            </svg>
          </div>
          <div
        ...
        <div className="flex flex-col gap-1">
          <div className="flex items-center gap-1">
            ...
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
              ...
              <text x="7.5" y="11" textAnchor="middle" fill="#a3a3a2" fontSize="8" fontFamily="Inter">i</text>
            </svg>
          </div>
          <div
            className="w-full px-3 py-2"
        ...
        <div className="flex gap-3 mt-1">
          <button
            ...
            style={{ backgroundColor: "#843a17", color: "#8c8078", fontSize: "11.5px", borderRadius: "4px", height: "37px" }}
          >
            Awesome
          </button>
          <button
