...
export const Title = ({
  ...
  // Title field is focused by default (autofocus) so the character counter is immediately visible
  ...
  // Show error only if error message is provided AND the title is empty or contains only spaces
  const requireError =
  ...
  const updateTitle = (newTitle: string) => {
    // Prevent exceeding max length by rejecting the update
