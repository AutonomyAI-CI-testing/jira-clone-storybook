export function TestCard() {
  return (
    <div
      id="testElem"
      className="w-64 min-h-[508px] flex flex-col gap-3 p-5 font-sans"
    ...
    >
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex items-center gap-2">
          <svg width="10" height="7" viewBox="0 0 10 7" fill="none" stroke="#b2b2b1" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            <polyline points="1,6 5,1 9,6" />
          </svg>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          >
            <span className="text-xs font-semibold" style={{ color: "#737470" }}>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          >
            <span className="text-xs font-semibold" style={{ color: "#71726e" }}>
        ...
        <div className="flex gap-3 mt-1">
          <button
            className="flex-1 py-2.5 px-4 rounded text-xs font-semibold"
      ...
      {/* Recent Breakdowns */}
      <span className="text-xs font-semibold" style={{ color: "#b0b0b0" }}>
        Recent Breakdowns
      </span>
    </div>
  );
