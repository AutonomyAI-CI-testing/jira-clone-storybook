export function TestCard() {
  return (
    <div
      id="testElem"
      className="w-64 flex flex-col bg-[#1a1a18]"
    ...
    >
      ...
      <div className="px-5 pb-4">
        ...
        <div className="mb-3">
          ...
          <div
            className="w-full px-3 py-2.5 bg-[#272822]"
        ...
        <div className="flex gap-3">
          <button
            className="flex-1 py-2.5 text-[11.5px] font-semibold text-[#8c8078] bg-[#843a17] rounded"
          >
            Awesome
          </button>
          <button
