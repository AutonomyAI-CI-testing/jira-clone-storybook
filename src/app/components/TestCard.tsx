export function TestCard() {
  return (
    <div id="testElem" className="w-64 bg-[#1a1a17] text-white flex flex-col py-5 font-sans">
      {/* Header row */}
      ...
      <div className="px-4">
        ...
        <div className="mb-3">
          ...
          <div className="bg-[#272822] border border-[#a5adad] px-3 py-2.5 h-[37px] flex items-center">
        ...
        <div className="mb-4">
          ...
          <div className="bg-[#272822] border-2 border-[#929291] px-3 py-2.5 h-[41px] flex items-center">
        ...
        <div className="flex gap-3">
          <button className="flex-1 bg-[#843a17] rounded text-[#8c8078] text-[11.5px] font-semibold leading-[13.92px] py-2.5 h-[37px] flex items-center justify-center">
            Awesome
          </button>
          <button className="flex-1 bg-[#843a17] rounded text-[#8c8078] text-[11.5px] font-semibold leading-[13.92px] py-2.5 h-[37px] flex items-center justify-center">
            Prepare
