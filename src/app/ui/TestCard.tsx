export function TestCard() {
  return (
    <div
      id="testElem"
      className="w-64 bg-[#1e1e1a] font-[Inter,sans-serif] rounded overflow-hidden"
    >
      {/* Header row */}
      ...
      <div className="px-4 pb-4">
        ...
        <div className="flex gap-3">
          <button className="flex-1 bg-[#843a17] rounded py-2 text-[11.5px] font-semibold text-[#8c8078] hover:opacity-90 transition-opacity">
            Awesome
          </button>
          <button className="flex-1 bg-[#843a17] rounded py-2 text-[11.5px] font-semibold text-[#8c8078] hover:opacity-90 transition-opacity">
            Prepare
      ...
      {/* Divider */}
      <div className="border-t border-[#2e2e2a]" />
