export function TestCard() {
  return (
    <div id="testElem" className="bg-[#1c1c1c] text-white min-h-screen p-5 font-sans max-w-sm mx-auto">
      {/* Header */}
      ...
      <div className="flex items-center gap-2 mb-8">
        ...
        <span className="text-sm text-[#a07050]">From entire frame to a singl...</span>
      </div>
      ...
      <div className="mb-4">
        ...
        <input
          ...
          className="w-full bg-[#2a2a2a] border border-[#3a3a3a] rounded px-3 py-2.5 text-sm text-gray-400 placeholder-gray-500 outline-none focus:border-gray-500"
        />
      </div>
      ...
      <div className="flex gap-3 mb-10">
        <button className="flex-1 bg-[#8B4513] hover:bg-[#9B5523] text-white font-semibold py-3 px-4 rounded-xl transition-colors">
          Awesome
        </button>
        <button className="flex-1 bg-[#8B4513] hover:bg-[#9B5523] text-white font-semibold py-3 px-4 rounded-xl transition-colors">
          Prepare
