...
export const TestCard = (): JSX.Element => {
  return (
    <div
      id="testElem"
      className="w-[254px] rounded-md bg-black px-5 py-5 font-sans"
    >
      {/* Header */}
      ...
      <div className="mt-16">
        ...
        <div className="mt-2 h-[39px] rounded border border-[#a5adad] bg-[#272822] px-3 py-2">
        ...
        <div className="mt-2 h-[37px] rounded border-2 border-[#929291] bg-[#272822] px-3 py-2">
