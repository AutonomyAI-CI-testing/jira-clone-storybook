...
export const Title = ({
  ...
  // Generic focus/blur handlers for both title and subtitle fields
  ...
  // Prevent input beyond maxLength by blocking the update entirely
  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="relative">
        ...
        {/* Character counter shown only when field is focused */}
        {isFocus && (
          <span
            className={cx(
