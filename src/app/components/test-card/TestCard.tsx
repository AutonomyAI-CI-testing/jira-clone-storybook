export const TestCard = () => {
  return (
    <div
      id="testElem"
      className="w-[254px] bg-[#1c1c1a] flex flex-col"
    ...
    >
      ...
      <div className="px-5">
        ...
        <div className="mb-5">
          ...
          <div className="w-full bg-[#272822] border-2 border-[#929291] px-3 py-2.5">
        ...
        <div className="flex gap-3 mb-6">
          <button className="flex-1 bg-[#843a17] rounded px-3 py-2.5 text-[11.5px] font-semibold text-[#8c8078]">
            Awesome
          </button>
          <button className="flex-1 bg-[#843a17] rounded px-3 py-2.5 text-[11.5px] font-semibold text-[#8c8078]">
            Prepare
