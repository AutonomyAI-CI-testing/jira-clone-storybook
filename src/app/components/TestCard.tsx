export function TestCard() {
  return (
    <div
      id="testElem"
      className="w-64 bg-[#1a1a17] flex flex-col font-sans"
    ...
    >
      ...
      {/* Subtitle row */}
      <div className="flex items-center gap-1.5 px-5 pb-8">
        {/* Chevron-up */}
        <svg
          xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="px-4 pb-4">
        ...
        <div className="flex gap-3">
          <button className="flex-1 bg-[#843a17] rounded text-[#8c8078] text-[11.5px] font-semibold py-2.5">
            Awesome
          </button>
          <button className="flex-1 bg-[#843a17] rounded text-[#8c8078] text-[11.5px] font-semibold py-2.5">
            Prepare
