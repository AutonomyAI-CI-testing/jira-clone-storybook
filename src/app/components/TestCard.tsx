export const TestCard = () => {
  return (
    <div
      id="testElem"
      className="bg-[#2a2a2a] text-white min-h-screen w-full max-w-[420px] mx-auto p-5 font-sans"
    >
      {/* Header */}
      ...
      {/* Subtitle row */}
      <div className="flex items-center gap-2 mb-10 text-[#c07a4a] text-sm">
        {/* Chevron-up icon */}
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="w-4 h-4"
      ...
      <div>
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full bg-transparent border border-gray-500 rounded px-3 py-3 text-sm text-gray-400 placeholder-gray-500 focus:outline-none focus:border-gray-400"
          />
        </div>
        ...
        <div className="flex gap-3">
          <button className="flex-1 bg-[#b85c2a] hover:bg-[#a04f22] text-white font-semibold py-3 px-4 rounded-xl transition-colors">
            Awesome
          </button>
          <button className="flex-1 bg-[#b85c2a] hover:bg-[#a04f22] text-white font-semibold py-3 px-4 rounded-xl transition-colors">
            Prepare
