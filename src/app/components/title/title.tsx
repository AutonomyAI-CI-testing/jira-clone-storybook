...
export const Title = ({
  ...
  // Track focus to show character counters only when the user is actively editing
  ...
  // Show error only if error prop is provided and subtitle is empty or whitespace-only
  ...
  // Enforce max length limit on title updates
  const updateTitle = (newTitle: string) => {
    if (newTitle.length > maxLength) return;
    setTitle(newTitle);
  };

  // Enforce max length limit on subtitle updates
