export function TestCard() {
  return (
    <div id="testElem" className="w-64 min-h-screen font-sans" style={{ backgroundColor: "#272822", fontFamily: "Inter, sans-serif" }}>
      {/* Header */}
        ...
        <div className="mb-3">
          <div className="flex items-center gap-1.5 mb-1.5">
            ...
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
              ...
              <text x="7" y="10.5" textAnchor="middle" fontSize="8" fill="#a4a4a3" fontFamily="Inter" fontWeight="700">i</text>
            </svg>
          </div>
          <div
        ...
        <div className="mb-5">
          <div className="flex items-center gap-1.5 mb-1.5">
            ...
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
              ...
              <text x="7" y="10.5" textAnchor="middle" fontSize="8" fill="#a3a3a2" fontFamily="Inter" fontWeight="700">i</text>
            </svg>
          </div>
          <div
            className="w-full px-3 py-2.5"
