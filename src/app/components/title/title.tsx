...
export const Title = ({
  ...
  // Validation: check if text is empty or only whitespace
  const isFieldEmpty = (value: string) =>
    value.length === 0 || textAreOnlySpaces(value);
  ...
  // Enforce max length on input — silently ignore characters beyond the limit
  ...
  // Shared error class applied when validation fails
      ...
      <div className="relative">
        <TextareaAutosize
          ...
          textareaClassName={cx(
            ...
            requireError && errorOutlineClass
          )}
          autofocus
        />
        {requireError && (
      ...
      <div className="relative">
        <TextareaAutosize
          ...
          textareaClassName={cx(
            ...
            requireSubtitleError && errorOutlineClass
          )}
        />
