  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 px-5 pb-4">
        <svg width="8" height="5" viewBox="0 0 10 6" fill="none" stroke="#8b9291" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="px-5">
        ...
        <div className="flex items-center gap-2 mb-4">
          <svg width="12" height="8" viewBox="0 0 10 6" fill="none" stroke="#b2b2b1" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
            <polyline points="1 5 5 1 9 5" />
          </svg>
