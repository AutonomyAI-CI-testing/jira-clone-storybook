export function TestCard() {
  return (
    <div
      id="testElem"
      style={{ fontFamily: "Inter, sans-serif", background: "#282823", width: "256px", padding: "0" }}
    >
      {/* Header row */}
      ...
      <div className="flex items-center gap-2 px-5 pb-8">
        {/* Chevron up */}
        <svg width="9" height="6" viewBox="0 0 10 7" fill="none" stroke="#8b9291" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="px-5">
        ...
        <div className="mb-3">
          ...
          >
            <span style={{ fontSize: "11.5px", fontWeight: 600, color: "#737470" }}>
        ...
        <div className="mb-5">
          ...
          >
            <span style={{ fontSize: "10.5px", fontWeight: 600, color: "#71726e" }}>
        ...
        <div className="flex gap-3 mb-8">
          <button
            ...
            style={{ background: "#843a17", borderRadius: "4px", fontSize: "11.5px", fontWeight: 600, color: "#8c8078", border: "none", cursor: "pointer" }}
          >
            Awesome
          </button>
          <button
