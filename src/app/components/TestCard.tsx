export function TestCard() {
  return (
    ...
    >
      {/* Top thin bar */}
      <div style={{ height: "9px", backgroundColor: "#1c1c1a", width: "100%" }} />
      ...
      <div className="flex items-center gap-1 px-5 pb-2">
        <span style={{ color: "#8b9291", fontSize: "11px", lineHeight: 1 }}>∧</span>
      ...
      <div className="px-5">
        ...
        <div className="flex items-center gap-2 mb-4">
          <span style={{ color: "#b2b2b1", fontSize: "12px", lineHeight: 1 }}>∧</span>
