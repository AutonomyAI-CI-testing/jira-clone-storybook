export const TestCard = () => {
  return (
    <div
      id="testElem"
      className="min-h-screen bg-[#1e1e1e] p-5 text-white"
    >
      {/* Header row */}
      ...
      <div className="mt-2 flex items-center gap-2">
        ...
        <span className="text-sm text-[#c1622a]/80">
      ...
      <div>
        ...
        <div className="mt-5">
          ...
          <input
            ...
            className="w-full rounded border border-[#444] bg-[#2a2a2a] px-3 py-2.5 text-sm text-gray-300 placeholder-gray-500 outline-none focus:border-[#666]"
          />
        </div>
        ...
        <div className="mt-4">
          ...
          <input
            ...
            className="w-full rounded border border-[#555] bg-[#2a2a2a] px-3 py-2.5 text-sm text-gray-300 placeholder-gray-500 outline-none focus:border-[#666]"
          />
        </div>
        ...
        <div className="mt-6 flex justify-center gap-4">
          <button
            type="button"
            className="rounded-lg bg-[#c1622a] px-8 py-3 text-sm font-semibold text-white"
          >
            Awesome
          </button>
          <button
