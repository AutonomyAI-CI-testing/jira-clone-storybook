export function TestCard() {
  return (
    <div
      id="testElem"
      className="w-[253px] min-h-screen bg-[#2a2a2a] text-white flex flex-col p-4 font-sans"
    >
      {/* Header */}
      ...
      {/* Subtitle */}
      <div className="flex items-center gap-2 text-sm text-[#c17a50] mb-8">
        {/* Chevron up */}
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="14"
      ...
      <div className="mb-6">
        ...
        <div className="flex gap-3">
          <button className="flex-1 bg-[#b85c2c] hover:bg-[#a04e24] text-white text-sm font-medium py-3 rounded-lg">
            Awesome
          </button>
          <button className="flex-1 bg-[#b85c2c] hover:bg-[#a04e24] text-white text-sm font-medium py-3 rounded-lg">
            Prepare
