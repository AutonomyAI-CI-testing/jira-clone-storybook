...
/**
 * TestCard component — UI for managing Figma design configurations.
 * Self-contained, no props. Uses a dark theme matching the Figma spec.
 */
      ...
      <div className="flex gap-3 mt-5 justify-center">
        {['Awesome', 'Prepare'].map((label) => (
          <button
            key={label}
            type="button"
            className="text-white text-xs font-semibold px-6 py-3 rounded-lg focus:outline-none transition-opacity hover:opacity-90"
