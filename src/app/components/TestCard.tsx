export function TestCard() {
  return (
    <div
      id="testElem"
      style={{ backgroundColor: "#1a1a18", width: "254px", minHeight: "508px", fontFamily: "Inter, sans-serif" }}
    ...
    >
      ...
      <div className="flex gap-3 px-5 pb-8">
        <button
          className="flex items-center justify-center rounded text-[11.5px] font-semibold"
          style={{
            width: "85px",
            height: "37px",
