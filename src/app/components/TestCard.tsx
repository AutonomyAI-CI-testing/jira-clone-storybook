export function TestCard() {
  return (
    <div
      id="testElem"
      className="w-[254px] min-h-[508px] bg-[#1a1a17] font-['Inter'] px-5 py-5 overflow-auto"
    >
      {/* Header row */}
      ...
      <div className="mb-5">
        ...
        <div className="w-full h-[37px] bg-[#272822] border-2 border-[#929291] flex items-center px-3">
          <span className="text-[10.5px] font-semibold text-[#71726e]">https://www.figma.com/file/:</span>
        </div>
      </div>
      ...
      <div className="flex gap-3 mb-8">
        <button className="flex-1 h-[37px] bg-[#843a17] rounded flex items-center justify-center">
          <span className="text-[11.5px] font-semibold text-[#8c8078]">Awesome</span>
        </button>
        <button className="flex-1 h-[37px] bg-[#843a17] rounded flex items-center justify-center">
          <span className="text-[11.5px] font-semibold text-[#8c8078]">Prepare</span>
        </button>
      </div>
