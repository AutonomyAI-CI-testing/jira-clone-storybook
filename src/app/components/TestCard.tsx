export function TestCard() {
  return (
    <div
      ...
      style={{ backgroundColor: "#252521", fontFamily: "Inter, sans-serif", width: "254px", minHeight: "508px" }}
    >
      {/* Header */}
      ...
      <div className="px-5">
        ...
        <div className="flex items-center gap-2 mb-1">
          ...
          <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
            ...
            <text x="7.5" y="11" textAnchor="middle" fill="#a4a4a3" fontSize="8.5" fontWeight="700" fontFamily="Inter">i</text>
          </svg>
        </div>
        <div
        ...
        <div className="flex items-center gap-2 mb-1">
          ...
          <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
            ...
            <text x="7.5" y="11" textAnchor="middle" fill="#a3a3a2" fontSize="8.5" fontWeight="700" fontFamily="Inter">i</text>
          </svg>
        </div>
        <div
        ...
        <div className="flex gap-3 mb-8">
          <button
            ...
            style={{ backgroundColor: "#843a17", color: "#8c8078", fontSize: "11.5px", fontWeight: 600, lineHeight: "13.92px", height: "37px", borderRadius: "4px" }}
          >
            Awesome
          </button>
          <button
