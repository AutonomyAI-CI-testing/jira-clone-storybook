export function TestCard() {
  return (
    <div
      id="testElem"
      className="flex flex-col w-64 min-h-screen px-5 pt-5"
      ...
      <div className="mb-3">
        <div className="flex items-center gap-2 mb-2">
          ...
          <svg width="15" height="15" viewBox="0 0 15 15" fill="none" stroke="#a4a4a3" strokeWidth="1.2">
            ...
            <circle cx="7.5" cy="4.8" r="0.6" fill="#a4a4a3" stroke="none" />
          </svg>
        </div>
        <div
      ...
      <div className="mb-5">
        <div className="flex items-center gap-2 mb-2">
          ...
          <svg width="15" height="15" viewBox="0 0 15 15" fill="none" stroke="#a3a3a2" strokeWidth="1.2">
            <circle cx="7.5" cy="7.5" r="6.5" />
            <path d="M7.5 7v3.5" strokeLinecap="round" />
            <circle cx="7.5" cy="4.8" r="0.6" fill="#a3a3a2" stroke="none" />
          </svg>
        </div>
        <div
          className="w-full px-3 py-2"
