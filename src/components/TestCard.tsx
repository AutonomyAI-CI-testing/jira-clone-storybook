export const TestCard = (): JSX.Element => {
  return (
    <div id="testElem">
      <div className="bg-[#1e1e1e] min-h-screen w-full p-5 flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            readOnly
            className="bg-[#2a2a2a] border border-[#3a3a3a] text-[#9ca3af] rounded px-3 py-2 w-full text-sm placeholder:text-[#9ca3af] outline-none"
          />
        </div>
        ...
        <div className="flex gap-4">
          <button className="bg-[#b85c2a] text-white rounded-lg px-6 py-3 font-semibold text-sm flex-1">
            Awesome
          </button>
          <button className="bg-[#b85c2a] text-white rounded-lg px-6 py-3 font-semibold text-sm flex-1">
            Prepare
