// TestCard — self-contained, zero props. Smoke-test component from Figma design.
export const TestCard = () => {
  return (
    <div
      id="testElem"
      className="w-[254px] bg-[#1e1e1a] font-sans overflow-hidden"
    >
      {/* Top decorative bar */}
      <div className="h-[9px] bg-[#111110]" />
