export const TestCard = () => {
  return (
    <div
      id="testElem"
      className="w-[254px] min-h-[508px] overflow-auto p-0"
    ...
    >
      ...
      <div className="px-5">
        ...
        <div
          className="w-full h-[37px] flex items-center px-3 mb-3 rounded"
          style={{
        ...
        <div
          className="w-full h-[37px] flex items-center px-3 mb-5 rounded"
          style={{
            backgroundColor: "#272822",
        ...
        <div className="flex gap-3 justify-center mb-8">
          <button
            className="h-[37px] w-[85px] rounded text-[11.5px] font-semibold leading-[14px]"
