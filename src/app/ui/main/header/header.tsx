...
export const Header = (): JSX.Element => {
  ...
  return (
    <header className="relative z-10 flex w-full items-center justify-between bg-white px-5 py-2 shadow-[0_1px_5px_-1px_rgba(0,0,0,0.3)]">
      <section>
        <Link
          to="/"
          className="flex cursor-pointer items-center rounded px-3 py-2 text-black hover:opacity-80"
        >
          <img src="/images/logo.png" width={24} height={24} alt="Logo" />
          <span className="ml-2 font-primary-bold">Fei</span>
        </Link>
      </section>
