export const TestCard = () => {
  return (
    <div
      id="testElem"
      className="bg-[#1a1a18] w-[254px] min-h-[508px] overflow-auto"
    ...
    >
      ...
      <div className="flex gap-3 px-5 mb-8">
        <button
          className="flex-1 bg-[#843a17] rounded text-[11.5px] font-semibold text-[#8c8078] py-2.5"
