export function TestCard() {
  return (
    <div
      id="testElem"
      style={{ backgroundColor: "#272822", width: 254, padding: 20, fontFamily: "Inter, sans-serif" }}
      ...
      <div className="flex flex-col gap-3 mt-2">
        ...
        <div className="flex gap-3 mt-1">
          <button
            ...
            style={{ backgroundColor: "#843a17", color: "#8c8078", fontSize: 11.5, fontWeight: 600, borderRadius: 4 }}
          >
            Awesome
          </button>
          <button
