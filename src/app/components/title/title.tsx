...
export const Title = ({
  ...
  // Computed states for max length validation and error display
  ...
  // Track focus state to show/hide character count indicators
  // When readOnly, focus state is not updated (input can't actually receive focus)
  const onFocus = () => {
  ...
  // Update handlers that enforce max length by preventing overflow
