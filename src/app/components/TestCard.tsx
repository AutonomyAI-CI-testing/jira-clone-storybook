...
export const TestCard = (): JSX.Element => {
  return (
    <div
      id="testElem"
      className="w-[254px] bg-[#1a1a17] text-[#b5b5b5] flex flex-col p-4 min-h-[508px]"
    ...
    >
      ...
      {/* Token input */}
      <div className="w-full rounded bg-[#272822] border border-[#a5adad] px-3 py-2 mb-3">
      ...
      {/* URL input */}
      <div className="w-full rounded bg-[#272822] border-2 border-[#929291] px-3 py-2 mb-5">
