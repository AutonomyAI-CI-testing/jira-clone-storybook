      ...
      <div className="px-5">
        ...
        <div className="flex items-center gap-2 mb-4">
          <svg width="12" height="8" viewBox="0 0 14 9" fill="none">
            <path d="M1 7L7 1L13 7" stroke="#b2b2b1" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
          <span
            className="font-semibold"
        ...
        <div className="flex gap-3 mb-6">
          <button
            className="flex-1 h-9 flex items-center justify-center rounded"
            style={{ backgroundColor: "#843a17" }}
          >
            <span
              className="font-semibold"
              style={{ color: "#8c8078", fontSize: "11.5px" }}
            >
              Awesome
            </span>
          </button>
