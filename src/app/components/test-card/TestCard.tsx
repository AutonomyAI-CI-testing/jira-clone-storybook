...
export const TestCard = (): JSX.Element => {
  return (
    <div
      id="testElem"
      className="w-[254px] rounded-md bg-[#1c1b17] p-3 font-['Inter']"
    >
      {/* Header */}
      ...
      <div className="mt-8">
        ...
        <input
          ...
          className="mt-1.5 w-full rounded border-[1px] border-[#a5adad] bg-[#272822] px-2.5 py-2 text-[11.5px] text-[#737470] placeholder-[#737470] outline-none"
        />
        ...
        <input
          ...
          className="mt-1.5 w-full rounded border-[2px] border-[#929291] bg-[#272822] px-2.5 py-2 text-[10.5px] text-[#71726e] placeholder-[#71726e] outline-none"
        />
