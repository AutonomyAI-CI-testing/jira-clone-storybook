export function TestCard() {
  return (
    ...
    >
      ...
      <div className="px-5">
        {/* Section heading: chevron-down + label */}
        <div className="flex items-center gap-2 mb-5">
          <svg width="10" height="7" viewBox="0 0 10 7" fill="none" stroke="#b2b2b1" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="flex gap-3">
          <button
            ...
            style={{ backgroundColor: "#843a17", color: "#8c8078", fontSize: "11.5px", borderRadius: "4px", border: "none" }}
          >
            Awesome
          </button>
          <button
