export const TestCard = () => {
  return (
    <div id="testElem" style={{ backgroundColor: "#000000" }} className="p-5 w-64 font-sans">
      {/* Header row */}
      <div className="flex items-center justify-between mb-3">
        <span style={{ color: "#b5b5b5", fontSize: "13.5px", fontWeight: 600, fontFamily: "Inter, sans-serif" }}>
          UI magician Agent
        </span>
        {/* Gear icon */}
      ...
      <div className="flex items-center gap-1 mb-6">
        ...
        <span style={{ color: "#8b9291", fontSize: "11.5px", fontWeight: 600, fontFamily: "Inter, sans-serif" }}>
      ...
      <div className="flex items-center gap-1 mb-4">
        ...
        <span style={{ color: "#b2b2b1", fontSize: "13.5px", fontWeight: 600, fontFamily: "Inter, sans-serif" }}>
          Add New Design
        </span>
      </div>
      ...
      <div className="mb-3">
        <div className="flex items-center gap-1 mb-1">
          <span style={{ color: "#a4a4a3", fontSize: "11.5px", fontWeight: 600, fontFamily: "Inter, sans-serif" }}>
      ...
      <div className="mb-4">
        <div className="flex items-center gap-1 mb-1">
          <span style={{ color: "#a3a3a2", fontSize: "11.5px", fontWeight: 600, fontFamily: "Inter, sans-serif" }}>
            Design URL
          </span>
      ...
      {/* Recent Breakdowns */}
      <div>
        <span style={{ color: "#b0b0b0", fontSize: "13.5px", fontWeight: 600, fontFamily: "Inter, sans-serif" }}>
          Recent Breakdowns
        </span>
      </div>
    </div>
