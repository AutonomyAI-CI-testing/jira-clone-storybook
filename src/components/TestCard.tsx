    ...
    >
      ...
      <div className="flex items-center gap-2 mb-2">
        ...
        <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
          ...
          <text x="7" y="11" textAnchor="middle" fill="#a4a4a3" fontSize="8" fontFamily="Inter" fontWeight="700">i</text>
        </svg>
      </div>
      <div
      ...
      <div className="flex items-center gap-2 mb-2">
        ...
        <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
          ...
          <text x="7" y="11" textAnchor="middle" fill="#a3a3a2" fontSize="8" fontFamily="Inter" fontWeight="700">i</text>
        </svg>
      </div>
      <div
