export const TestCard = () => {
  return (
    <div
      id="testElem"
      className="w-[254px] bg-[#272822] flex flex-col gap-4 p-5"
    ...
    >
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          <div
            className="w-full h-[36px] flex items-center px-3 bg-[#272822]"
        ...
        <div className="flex flex-col gap-1">
          ...
          <div
            className="w-full h-[37px] flex items-center px-3 bg-[#272822]"
        ...
        <div className="flex gap-3">
          <button
            className="flex-1 h-[37px] flex items-center justify-center rounded bg-[#843a17]"
          >
