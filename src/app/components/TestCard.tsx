export function TestCard() {
  return (
    <div
      ...
      style={{ backgroundColor: "#272822", fontFamily: "Inter, sans-serif", minHeight: "100vh" }}
    >
      {/* Header row */}
      ...
      <div className="px-5 pb-6">
        <div
          className="flex items-center px-3 py-2"
          style={{ backgroundColor: "#272822", border: "2px solid #929291", minHeight: "37px" }}
        >
      ...
      <div className="flex gap-3 px-5 pb-8">
        <button
          className="flex-1 flex items-center justify-center font-semibold py-2"
          style={{ backgroundColor: "#843a17", color: "#8c8078", fontSize: "11.5px", borderRadius: "4px", minHeight: "37px" }}
        >
          Awesome
        </button>
        <button
