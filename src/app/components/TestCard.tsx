    ...
    >
      ...
      <div className="px-5">
        ...
        <div className="mb-3">
          ...
          <div className="w-full rounded px-3 py-2" style={{ backgroundColor: "#272822", border: "1px solid #a5adad" }}>
        ...
        <div className="mb-5">
          ...
          <div className="w-full rounded px-3 py-2" style={{ backgroundColor: "#272822", border: "2px solid #929291" }}>
