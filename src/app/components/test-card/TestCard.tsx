export const TestCard = () => {
  return (
    <div
      id="testElem"
      style={{ backgroundColor: "#272823", width: "254px", minHeight: "508px", fontFamily: "Inter, sans-serif" }}
      className="flex flex-col"
    >
      {/* Header */}
      <div className="flex items-center justify-between px-5 pt-5 pb-2">
        <span className="font-semibold text-[13.5px] leading-[16.34px]" style={{ color: "#b5b5b5" }}>
          UI magician Agent
        </span>
        {/* Gear icon */}
      ...
      <div className="flex items-center gap-2 px-5 pb-6">
        ...
        <span className="font-semibold text-[11.5px] leading-[13.92px] truncate" style={{ color: "#8b9291" }}>
      ...
      <div className="px-5 pb-3">
        ...
        <div className="flex gap-3">
          <button
            className="flex-1 rounded py-2 font-semibold text-[11.5px] leading-[13.92px]"
