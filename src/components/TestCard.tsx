export function TestCard() {
  return (
    <div
      id="testElem"
      style={{ backgroundColor: "#272822", fontFamily: "Inter, sans-serif", width: "254px", minHeight: "508px", display: "flex", flexDirection: "column" }}
    >
      {/* Header */}
      ...
      <div className="flex items-center gap-2 px-5 pb-6">
        ...
        <span className="truncate" style={{ color: "#8b9291", fontSize: "11.5px", fontWeight: 600 }}>
      ...
      <div className="px-5 pb-4">
        ...
        <div className="mb-3">
          ...
          <div style={{ backgroundColor: "#272822", border: "1px solid #a5adad", height: "36px", display: "flex", alignItems: "center", padding: "0 10px" }}>
        ...
        <div className="mb-4">
          ...
          <div style={{ backgroundColor: "#272822", border: "2px solid #929291", height: "37px", display: "flex", alignItems: "center", padding: "0 10px" }}>
        ...
        <div className="flex gap-3">
          <button
            style={{ backgroundColor: "#843a17", color: "#8c8078", fontSize: "11.5px", fontWeight: 600, width: "85px", height: "37px", borderRadius: "4px", border: "none", cursor: "pointer" }}
          >
            Awesome
          </button>
          <button
