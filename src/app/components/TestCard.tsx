export function TestCard() {
  return (
    <div
      ...
      className="flex flex-col min-h-96 py-5"
    >
      {/* Header row */}
      ...
      <div className="px-5">
        ...
        <div className="mb-3">
          ...
          >
            <span className="font-semibold truncate" style={{ color: "#737470", fontSize: "11.5px" }}>
        ...
        <div className="mb-5">
          ...
          >
            <span className="font-semibold truncate" style={{ color: "#71726e", fontSize: "10.5px" }}>
