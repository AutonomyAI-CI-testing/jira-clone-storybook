export function TestCard() {
  return (
    <div
      id="testElem"
      style={{ backgroundColor: "#1a1a17", fontFamily: "Inter, sans-serif", width: "254px", minHeight: "508px" }}
      ...
      <div className="px-5 pb-4">
        <div className="flex items-center gap-2 mb-5">
          <svg width="12" height="8" viewBox="0 0 12 8" fill="none">
            <path d="M1 6L6 1L11 6" stroke="#b2b2b1" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        ...
        <div className="mb-4">
          <div className="flex items-center gap-1.5 mb-2">
            ...
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
              ...
              <text x="7.5" y="11" textAnchor="middle" fill="#a4a4a3" fontSize="8.5" fontFamily="Inter" fontWeight="600">i</text>
            </svg>
          </div>
          <div
            style={{ backgroundColor: "#272822", border: "1px solid #a5adad", borderRadius: "3px" }}
        ...
        <div className="mb-5">
          <div className="flex items-center gap-1.5 mb-2">
            ...
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
              ...
              <text x="7.5" y="11" textAnchor="middle" fill="#a3a3a2" fontSize="8.5" fontFamily="Inter" fontWeight="600">i</text>
            </svg>
          </div>
          <div
            style={{ backgroundColor: "#272822", border: "2px solid #929291", borderRadius: "3px" }}
            className="w-full px-3 py-2.5"
          >
            <span style={{ color: "#71726e", fontSize: "11.5px", fontWeight: 600, lineHeight: "13.92px" }}>
