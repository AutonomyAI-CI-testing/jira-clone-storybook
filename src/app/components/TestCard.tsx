export function TestCard() {
  return (
    <div
      id="testElem"
      className="w-64 bg-[#272822] font-['Inter'] p-5 flex flex-col gap-4"
    >
      {/* Header row */}
      ...
      <div className="flex flex-col gap-4 mt-2">
        ...
        <div className="flex gap-3">
          <button className="bg-[#843a17] rounded px-5 py-2 text-[#8c8078] font-semibold text-[11.5px] leading-[13.92px]">
            Awesome
          </button>
          <button className="bg-[#843a17] rounded px-5 py-2 text-[#8c8078] font-semibold text-[11.5px] leading-[13.92px]">
            Prepare
