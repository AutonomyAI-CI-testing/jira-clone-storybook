...
const DEFAULT_SUBTITLE_MAX_LENGTH = 255;
...
export const Title = ({
  ...
  // Only show error if required AND field is empty or contains only whitespace
  ...
  // Show character counter only when focused and editable
  const onFocus = () => {
  ...
  // Enforce max length limit by rejecting updates that exceed the limit
