...
export const Title = ({
  ...
  subtitlePlaceholder = "Write a subtitle or description",
}: TitleProps): JSX.Element => {
  const [title, setTitle] = useState<string>(initTitle);
  const [subtitle, setSubtitle] = useState<string>(initSubtitle);
  // Title input is focused by default via autofocus prop
  ...
  // Only show error when field is truly empty (zero length or only whitespace)
  const requireError =
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="relative">
        <TextareaAutosize
          ...
          textareaClassName={cx(
            "font-primary text-base text-font-subtle",
