export const TestCard = () => {
  return (
    <div
      id="testElem"
      style={{ backgroundColor: "#2a2a2a", color: "#e5e5e5", minHeight: "100vh" }}
      className="p-6 flex flex-col gap-4 max-w-sm"
    >
      {/* Header */}
      ...
      <div className="flex items-center gap-2">
        ...
        <span style={{ color: "#b5522a" }} className="text-sm">
      ...
      <div className="flex flex-col gap-2">
        ...
        <input
          ...
          className="w-full rounded border px-3 py-3 text-sm placeholder-gray-500 outline-none"
        />
      </div>
