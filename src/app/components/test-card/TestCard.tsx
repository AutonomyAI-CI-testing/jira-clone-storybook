export const TestCard = () => {
  return (
    <div
      id="testElem"
      className="bg-[#1a1a18] w-[254px] min-h-[508px] font-sans flex flex-col"
    >
      {/* Header */}
      ...
      <div className="px-5 flex-1">
        ...
        <div className="mb-4">
          ...
          <div className="bg-[#272822] border border-[#a5adad] rounded px-3 py-2 w-full">
        ...
        <div className="mb-5">
          ...
          <div className="bg-[#272822] border-2 border-[#929291] rounded px-3 py-2 w-full">
