...
export const TestCard = (): JSX.Element => {
  return (
    <div
      id="testElem"
      className="w-full max-w-[400px] rounded-md bg-[#1a1a1a] p-5 font-['Inter']"
    >
      {/* Header */}
      ...
      <div className="mt-4">
        ...
        <div className="mt-2 h-10 rounded-sm border-2 border-[#929291] bg-[#272822] px-3 py-2">
      ...
      <div className="mt-4">
        ...
        <div className="mt-2 h-9 rounded-sm border border-[#a5adad] bg-[#272822] px-3 py-2">
