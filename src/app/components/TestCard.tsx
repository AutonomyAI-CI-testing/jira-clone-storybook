export function TestCard() {
  return (
    <div
      id="testElem"
      style={{ backgroundColor: "#2b2b27", fontFamily: "Inter, sans-serif", width: "254px" }}
    ...
    >
      ...
      <div className="flex items-center gap-2 px-5 pb-8">
        {/* Chevron up */}
        <svg width="8" height="6" viewBox="0 0 10 7" fill="none" stroke="#8b9291" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="px-5">
        ...
        <div className="flex gap-3 mb-8">
          <button
            style={{ backgroundColor: "#843a17", color: "#8c8078", fontSize: "11.5px", fontWeight: 600, borderRadius: "4px" }}
