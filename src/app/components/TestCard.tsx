export function TestCard() {
  return (
    <div
      id="testElem"
      className="w-[254px] bg-[#272822] overflow-auto"
    ...
    >
      ...
      <div className="px-4 pb-2">
        ...
        {/* Token input */}
        <div className="bg-[#272822] border border-[#a5adad] rounded px-3 py-2.5 mb-4">
        ...
        {/* URL input */}
        <div className="bg-[#272822] border-2 border-[#929291] rounded px-3 py-2.5 mb-5">
        ...
        <div className="flex gap-3">
          <button
            className="flex-1 bg-[#843a17] rounded py-2.5 text-[#8c8078] text-[11.5px] font-semibold leading-[13.92px] text-center"
