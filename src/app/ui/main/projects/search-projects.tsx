...
export const SearchProjects = ({ search, setSearch }: Props): JSX.Element => {
    ...
    <div className="relative w-fit">
      <input
        ...
        className={cx(
          ...
          "border-1 box-border pl-3 pr-8 outline outline-2 outline-border-input duration-200 ease-in-out",
