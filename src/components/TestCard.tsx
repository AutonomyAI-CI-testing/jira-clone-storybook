export function TestCard() {
  return (
    <div
      id="testElem"
      className="flex flex-col w-[254px] min-h-[508px] bg-[#272822] font-[Inter,sans-serif]"
    >
      {/* Header */}
      ...
      <div className="px-5 pb-4">
        ...
        <div className="flex gap-3">
          <button className="flex-1 h-[37px] rounded bg-[#843a17] flex items-center justify-center">
