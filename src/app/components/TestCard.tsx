        ...
        <div className="mb-3">
          <div className="flex items-center gap-2 mb-1">
            ...
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
              ...
              <text x="7.5" y="11.5" textAnchor="middle" fill="#a4a4a3" fontSize="8" fontFamily="Inter" fontWeight="600">i</text>
            </svg>
          </div>
          <div
        ...
        <div className="mb-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
              ...
              <text x="7.5" y="11.5" textAnchor="middle" fill="#a3a3a2" fontSize="8" fontFamily="Inter" fontWeight="600">i</text>
            </svg>
          </div>
          <div
            className="w-full rounded px-3 py-2"
