export const TestCard = () => {
  return (
    <div
      id="testElem"
      style={{ backgroundColor: "#2a2a25", width: "254px", minHeight: "508px" }}
    ...
    >
      ...
      <div className="flex items-center justify-between px-5 pt-5 pb-3">
        <span
          ...
          style={{ color: "#b5b5b5", fontSize: "13.5px", fontFamily: "Inter, sans-serif" }}
        >
          UI magician Agent
        </span>
        {/* Gear icon */}
      ...
      <div className="flex items-center gap-2 px-5 pb-8">
        ...
        <span
          ...
          style={{ color: "#8b9291", fontSize: "11.5px", fontFamily: "Inter, sans-serif" }}
        >
      ...
      <div className="px-5 pb-4">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span
            className="font-semibold"
            style={{ color: "#b2b2b1", fontSize: "13.5px", fontFamily: "Inter, sans-serif" }}
          >
            Add New Design
          </span>
        </div>
        ...
        <div className="mb-3">
          <div className="flex items-center gap-2 mb-2">
            <span
              className="font-semibold"
              style={{ color: "#a4a4a3", fontSize: "11.5px", fontFamily: "Inter, sans-serif" }}
            >
              Personal Access Token
            </span>
            {/* Info icon */}
          ...
          >
            <span
              className="font-semibold"
              style={{ color: "#737470", fontSize: "11.5px", fontFamily: "Inter, sans-serif" }}
            >
        ...
        <div className="mb-5">
          <div className="flex items-center gap-2 mb-2">
            <span
              className="font-semibold"
              style={{ color: "#a3a3a2", fontSize: "11.5px", fontFamily: "Inter, sans-serif" }}
            >
              Design URL
            </span>
            {/* Info icon */}
          ...
          >
            <span
              className="font-semibold"
              style={{ color: "#71726e", fontSize: "10.5px", fontFamily: "Inter, sans-serif" }}
            >
      ...
      <div className="px-5 pt-6">
        <span
          className="font-semibold"
          style={{ color: "#b0b0b0", fontSize: "13.5px", fontFamily: "Inter, sans-serif" }}
        >
          Recent Breakdowns
        </span>
      </div>
